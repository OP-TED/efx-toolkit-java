...
template: lbl=labelReference templ=template? # LabelTemplate
	| val=valueReference templ=template? # ValueTemplate
	| txt=literal templ=template? # TextTemplate
	;

labelReference: '#' fieldId=FieldId '#';
