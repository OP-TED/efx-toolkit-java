...
public class SdkEntityFactory extends VersionDependentComponentFactory {
  ...
  public static SdkCodelist getSdkCodelist(final String sdkVersion, final String codelistId,
      final String codelistVersion, final List<String> codes,
      final Optional<String> parentCodelistIdOpt) throws InstantiationException {
    return SdkEntityFactory.INSTANCE.getComponentImpl(sdkVersion,
        VersionDependentComponentType.CODELIST, SdkCodelist.class, codelistId, codelistVersion,
        codes, parentCodelistIdOpt);
  }

  public static SdkField getSdkField(String sdkVersion, JsonNode field)
      throws InstantiationException {
    return SdkEntityFactory.INSTANCE.getComponentImpl(sdkVersion,
        VersionDependentComponentType.FIELD, SdkField.class, field);
  }

  public static SdkNode getSdkNode(String sdkVersion, JsonNode node) throws InstantiationException {
    return SdkEntityFactory.INSTANCE.getComponentImpl(sdkVersion,
        VersionDependentComponentType.NODE, SdkNode.class, node);
  }
}
