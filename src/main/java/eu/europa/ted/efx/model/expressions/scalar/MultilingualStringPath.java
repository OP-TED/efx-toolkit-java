...
/**
 * A multilingual-string-typed path AST node, extending {@link StringPath}.
 *
 * References an eForms Field that may have multiple language versions.
 */
@EfxDataTypeAssociation(dataType = EfxDataType.MultilingualStringScalar.class)
public class MultilingualStringPath extends StringPath {

  public MultilingualStringPath(final String script) {
