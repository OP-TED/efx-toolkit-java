...
public class SymbolResolverMock implements SymbolResolver {
  ...
  public void loadMapData() throws JsonMappingException, JsonProcessingException {
    this.fieldById = Map.ofEntries(//
        ...
        entry("BT-00-Code", new SdkField07(fromString(
        ...
        entry("BT-00-Internal-Code", new SdkField07(fromString(
        ...
        entry("BT-00-Text-Multilingual", new SdkField07(fromString(
        ...
        entry("BT-00-StartDate", new SdkField07(fromString(
        ...
        entry("BT-00-Integer", new SdkField07(fromString(
        ...
        entry("BT-00-Zoned-Time", new SdkField07(fromString(
    ...
    this.nodeById =
        Map.ofEntries(entry("ND-Root", new SdkNode07("ND-Root", null, "/*", "/*", false)));

    this.codelistById = new HashMap<>(Map.ofEntries(entry("accessibility",
        new SdkCodelist07("accessibility", "0.0.1", Arrays.asList("code1", "code2", "code3")))));
  }
