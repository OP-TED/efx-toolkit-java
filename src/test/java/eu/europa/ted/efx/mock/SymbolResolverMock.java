...
import eu.europa.ted.efx.model.AnySdkCodelist;
import eu.europa.ted.efx.model.AnySdkField;
import eu.europa.ted.efx.model.AnySdkNode;
...
public class SymbolResolverMock implements SymbolResolver {
  ...
  public void loadMapData() throws JsonMappingException, JsonProcessingException {
    this.fieldById = Map.ofEntries(//
        ...
        entry("BT-00-Indicator", new AnySdkField(fromString(
        ...
        entry("BT-00-Code", new AnySdkField(fromString(
        ...
        entry("BT-00-Internal-Code", new AnySdkField(fromString(
        ...
        entry("BT-00-Text-Multilingual", new AnySdkField(fromString(
        ...
        entry("BT-00-StartDate", new AnySdkField(fromString(
        ...
        entry("BT-00-Integer", new AnySdkField(fromString(
        ...
        entry("BT-00-Zoned-Time", new AnySdkField(fromString(
    ...
    this.nodeById =
        Map.ofEntries(entry("ND-Root", new AnySdkNode("ND-Root", null, "/*", "/*", false)));

    this.codelistById = new HashMap<>(Map.ofEntries(entry("accessibility",
        new AnySdkCodelist("accessibility", "0.0.1", Arrays.asList("code1", "code2", "code3")))));
  }
