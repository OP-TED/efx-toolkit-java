...
<pattern id="EFORMS-validation-stage-2a-1" xmlns="http://purl.oclc.org/dsdl/schematron">
    <rule context="/*/PathNode/TextField">
        ...
        <let name="__apiResult8" value="efx:call-api($apiUrl-staging, 'validate-ref', (../IdField/normalize-space(text())))"/>
        <assert id="R-S2A-002-api-error-1" role="ERROR" test="not($__apiResult8 = -1)">auxiliary|text|ref-check-failed</assert>
        <let name="__apiResult9" value="efx:call-api($apiUrl-default, 'check-buyer', (../IdField/normalize-space(text())))"/>
        ...
        <let name="__apiResult10" value="efx:call-api($apiUrl-ext-db, 'verify-code', (../IdField/normalize-space(text()), ../CodeField/normalize-space(text())))"/>
        <assert id="R-S2A-003-api-error-1" role="WARNING" test="not($__apiResult10 = -1)">rule|text|api-warning</assert>
        <let name="__apiResult11" value="efx:call-api($apiUrl-default, 'confirm-status', (../IdField/normalize-space(text())))"/>
    ...
    <rule context="/*/SubNode">
        ...
        <let name="__apiResult12" value="efx:call-api($apiUrl-staging, 'validate-ref', (../PathNode/IdField/normalize-space(text())))"/>
