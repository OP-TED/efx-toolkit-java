...
<pattern id="EFORMS-validation-stage-1a-2" xmlns="http://purl.oclc.org/dsdl/schematron">
    <rule context="/*/PathNode/TextField">
        ...
        <report id="R-B6J-C4R" role="INFO" test="(not(./normalize-space(text()) = '')) or (not(not(./normalize-space(text()) = 'open') and not(./normalize-space(text()) = 'restricted') and not(./normalize-space(text()) = 'negotiated')))">rule|text|R-B6J-C4R</report>
    </rule>
</pattern>
