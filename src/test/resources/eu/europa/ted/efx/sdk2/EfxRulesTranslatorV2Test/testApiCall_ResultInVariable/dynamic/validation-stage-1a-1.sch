...
<pattern id="EFORMS-validation-stage-1a-1" xmlns="http://purl.oclc.org/dsdl/schematron">
    <let name="stageOk" value="efx:call-api('default', 'confirm-status', /*/PathNode/CodeField/normalize-space(text()))"/>
    <let name="statusOk" value="efx:call-api('default', 'confirm-status', /*/PathNode/CodeField/normalize-space(text()))"/>
    <rule context="/*/PathNode/TextField">
        <let name="buyerOk" value="efx:call-api('default', 'check-buyer', ../IdField/normalize-space(text()))"/>
        ...
        <let name="__apiResult1" value="efx:call-api('default', 'verify-code', ../IdField/normalize-space(text()), ../CodeField/normalize-space(text()))"/>
