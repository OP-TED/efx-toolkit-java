...
<pattern id="EFORMS-validation-stage-2a-1" xmlns="http://purl.oclc.org/dsdl/schematron">
    <rule context="/*/PathNode/TextField">
        ...
        <let name="__apiResult5" value="efx:call-api($apiUrl-default, 'check-buyer', (../IdField/normalize-space(text())))"/>
        <assert id="R-S2A-002-api-error-1" role="ERROR" test="not($__apiResult5 = -1)">rule|text|api-error</assert>
    ...
    <rule context="/*/SubNode">
        ...
        <let name="__apiResult6" value="efx:call-api($apiUrl-default, 'check-code', (../PathNode/CodeField/normalize-space(text())))"/>
        <assert id="R-S2A-004-api-error-1" role="WARNING" test="not($__apiResult6 = -1)">rule|text|api-warning</assert>
