...
<pattern id="EFORMS-validation-stage-2a-1" xmlns="http://purl.oclc.org/dsdl/schematron">
    <rule context="/*/PathNode/TextField">
        ...
        <let name="__apiResult5" value="efx:call-api('default', 'check-buyer', ../IdField/normalize-space(text()))"/>
    ...
    <rule context="/*/SubNode">
        ...
        <let name="__apiResult6" value="efx:call-api('default', 'check-code', ../PathNode/CodeField/normalize-space(text()))"/>
