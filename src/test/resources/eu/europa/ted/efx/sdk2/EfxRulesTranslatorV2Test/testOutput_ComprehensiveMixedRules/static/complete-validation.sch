...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
    ...
    <diagnostics>
        ...
        <diagnostic id="ND-SubNode_BT-00-Number" see="field:BT-00-Number">../PathNode/NumberField</diagnostic>
        ...
        <diagnostic id="BT-00-Number_BT-00-Text" see="field:BT-00-Text">../TextField</diagnostic>
        <diagnostic id="BT-00-Number_BT-00-Indicator" see="field:BT-00-Indicator">../IndicatorField</diagnostic>
        <diagnostic id="BT-00-Indicator_BT-00-Text" see="field:BT-00-Text">../TextField</diagnostic>
        <diagnostic id="BT-00-Indicator_BT-00-Number" see="field:BT-00-Number">../NumberField</diagnostic>
