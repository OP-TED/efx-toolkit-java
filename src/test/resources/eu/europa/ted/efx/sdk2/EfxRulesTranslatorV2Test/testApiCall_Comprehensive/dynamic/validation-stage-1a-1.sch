...
<pattern id="EFORMS-validation-stage-1a-1" xmlns="http://purl.oclc.org/dsdl/schematron">
    <let name="stageStatus" value="efx:call-api($apiUrl-default, 'confirm-status', (/*/PathNode/CodeField/normalize-space(text())))"/>
    <let name="buyerOk" value="efx:call-api($apiUrl-default, 'check-buyer', (/*/PathNode/IdField/normalize-space(text())))"/>
    <rule context="/*/PathNode/TextField">
        ...
        <let name="__apiResult1" value="efx:call-api($apiUrl-default, 'check-buyer', (../IdField/normalize-space(text())))"/>
        ...
        <let name="__apiResult2" value="efx:call-api($apiUrl-default, 'check-buyer', (../IdField/normalize-space(text())))"/>
        <assert id="R-S1A-004-api-error-1" role="ERROR" test="not($__apiResult2 = -1)">rule|text|api-error</assert>
        <let name="__apiResult3" value="efx:call-api($apiUrl-ext-db, 'verify-code', (../IdField/normalize-space(text()), ../CodeField/normalize-space(text())))"/>
        ...
        <let name="__apiResult4" value="efx:call-api($apiUrl-default, 'confirm-status', (../IdField/normalize-space(text())))"/>
        ...
        <let name="__apiResult5" value="efx:call-api($apiUrl-ext-db, 'verify-code', (../IdField/normalize-space(text()), ../CodeField/normalize-space(text())))"/>
    ...
    <rule context="/*/PathNode/TextField">
        ...
        <let name="__apiResult6" value="efx:call-api($apiUrl-default, 'check-buyer', (../IdField/normalize-space(text())))"/>
        ...
        <let name="__apiResult7" value="efx:call-api($apiUrl-default, 'check-buyer', (../IdField/normalize-space(text())))"/>
