...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:efx="http://eforms.ted.europa.eu/efx" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" queryBinding="xslt2">
    ...
    <let name="globalOk" value="efx:call-api($apiUrl-default, 'check-global', (/*/PathNode/CodeField/normalize-space(text())))"/>
    ...
    <diagnostics>
        <diagnostic id="ND-SubNode_BT-01-SubLevel-Text" see="field:BT-01-SubLevel-Text">../PathNode/ChildNode/SubLevelTextField</diagnostic>
    </diagnostics>
