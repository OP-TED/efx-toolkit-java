...
<pattern id="EFORMS-validation-stage-1a-1" xmlns="http://purl.oclc.org/dsdl/schematron">
    <rule context="/*/PathNode/TextField">
        ...
        <let name="__apiResult2" value="efx:call-api($apiUrl-default, 'check-code', (../CodeField/normalize-space(text())))"/>
    ...
    <rule context="/*/PathNode/TextField">
        ...
        <let name="__apiResult3" value="efx:call-api($apiUrl-default, 'check-buyer', (../IdField/normalize-space(text())))"/>
        <assert id="R-S1A-004-api-error-1" role="ERROR" test="not($__apiResult3 = -1)">rule|text|api-error</assert>
        <let name="__apiResult4" value="efx:call-api($apiUrl-default, 'check-code', (../CodeField/normalize-space(text())))"/>
